    ...
    private void sendWebhook(class_1923 cpos, int count) {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                String body = String.format("{\"content\":\"%s\",\"username\":\"Meteor SpawnerNotifier\",\"embeds\":[{\"title\":\"Spawner Alert\",\"description\":\"%s\",\"color\":15158332,\"fields\":[{\"name\":\"Coords\",\"value\":\"%d, %d\",\"inline\":true},{\"name\":\"Server\",\"value\":\"%s\",\"inline\":true}]}]}", SpawnerNotifier.escape(ping), SpawnerNotifier.escape(desc), cx, cz, SpawnerNotifier.escape(server));
